          ...
          <Card bg="gray.50" w="full" borderLeft="4px solid" borderColor="#2D3748">
            <CardBody>
              ...
              <Text color="gray.600" fontSize="sm">
                The watchlist helps you monitor career pages of companies you're interested in. Add company career sites to keep track of when you last visited them and stay updated on new opportunities. Each entry can be modified to update the last visit date, making it easy to manage your job search across multiple organizations.
              </Text>
            </CardBody>
          </Card>
